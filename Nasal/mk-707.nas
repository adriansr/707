...
var show_alti = func {
  ...
  if(alt_on){
    if (alt_ft < 10000) {
        ...
        help_win.write(sprintf("With %.2f inhg the actual altitude is: %.0f ft. AGL is above 10000 ft", press_inhg, s_alti) );
    }
  }else{
...
var show_lat_lon = func {
	...
	dgc1 = dgc1*f1;
	dgc2 = dgc2*f2;
	help_win.write(sprintf("Compass Controller 1 lat: "~dgc1~" / Compass Controller 2 lat: "~dgc2));
}
